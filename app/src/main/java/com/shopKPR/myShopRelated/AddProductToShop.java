...
import com.shopKPR.Model.add_product_model;
import com.shopKPR.Model.product_database_model;
...
public class AddProductToShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_product_model add_product_model = (com.shopKPR.Model.add_product_model) getIntent().getSerializableExtra("add_product_model");
