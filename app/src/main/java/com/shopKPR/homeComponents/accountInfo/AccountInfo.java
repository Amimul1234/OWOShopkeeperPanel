package com.shopKPR.homeComponents.accountInfo;
...
public class AccountInfo extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent intent = new Intent(AccountInfo.this, ChangePin.class);
        ...
        LinearLayout paymentLayout, myReviewsLayout, notificationsLayout, promosLayout;

        paymentLayout = findViewById(R.id.payment_layout);
        myReviewsLayout = findViewById(R.id.review_layout);
        notificationsLayout = findViewById(R.id.notification_layout);
        promosLayout = findViewById(R.id.promos_layout);



        paymentLayout.setOnClickListener(v ->
                Toast.makeText(this, "Coming soon...", Toast.LENGTH_SHORT).show());
        myReviewsLayout.setOnClickListener(v ->
                Toast.makeText(this, "Coming soon...", Toast.LENGTH_SHORT).show());
        ...
        promosLayout.setOnClickListener(v ->
                Toast.makeText(this, "Coming soon...", Toast.LENGTH_SHORT).show());
    }
        ...
        RetrofitClient.getInstance().getApi()
                ...
                .enqueue(new Callback<ShopKeeperUser>() {
                    ...
                    public void onResponse(@NotNull Call<ShopKeeperUser> call, @NotNull Response<ShopKeeperUser> response) {
                        ...
                        {
                            progressDialog.dismiss();
                            Toast.makeText(AccountInfo.this, "Failed to load user information, please try again", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", (dialog, which) -> {
                        ...
                        ActivityCompat.requestPermissions(AccountInfo.this,
                                new String[] {Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);

                        selectImage(AccountInfo.this);
                    })
    ...
    private void uploadImageToServer()
    {
        ...
        File file = new File(AccountInfo.this.getCacheDir() + File.separator + filename + ".jpg");
        ...
        RetrofitClient.getInstance().getApi()
                ...
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                        if(response.isSuccessful())
                        {
                            try {
                                ...
                                Toast.makeText(AccountInfo.this, "Error occurred, please try again", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else
                        {
                            progressDialog.dismiss();
                            Toast.makeText(AccountInfo.this, "Failed to upload product image, please try again", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(@NotNull Call<ResponseBody> call, @NotNull Throwable t) {
                        ...
                        Toast.makeText(AccountInfo.this, "Failed to upload image, please try again", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        RetrofitClient.getInstance().getApi()
                ...
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                        ...
                        {
                            progressDialog.dismiss();
                            Toast.makeText(AccountInfo.this, "Sorry! Can not update your info. , Please try again", Toast.LENGTH_SHORT).show();
                        }
